import numpy as np
brokered_by, status, price, bed, bath,acre_lot, zip_code,house_size = np.genfromtxt('Class-data-science/RealEstate-USA.csv', delimiter=',', usecols= (0,1,2,3,4,6,9,10), unpack=True ,dtype= None, skip_header=1 )
print(brokered_by)
print(status)
print(price)
print(zip_code)
